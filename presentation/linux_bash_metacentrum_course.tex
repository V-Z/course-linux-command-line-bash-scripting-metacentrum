...
\begin{frame}{Manuals for package management}
	\begin{itemize}
		...
		\item Red Hat, Fedora, CENTOS, Scientific Linux and others: \url{https://docs.fedoraproject.org/en-US/quick-docs/dnf/} and older \url{http://yum.baseurl.org/}
...
\begin{frame}[allowframebreaks]{CESNET and MetaCentrum}
	...
	\begin{itemize}
		...
		\item MetaCentrum has 11~\href{https://docs.metacentrum.cz/en/docs/computing/infrastructure/frontends}{frontends} where users log and thousands of computers doing the calculations --- they are not accessed directly to run task
