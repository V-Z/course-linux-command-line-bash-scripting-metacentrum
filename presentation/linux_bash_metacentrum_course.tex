...
\begin{frame}{BASH globbing and wildcards}
  \label{globbing}
  \begin{itemize}
    \item BASH itself doesn't recognize regular expressions -- it's wildcards have some of functions of regular expressions and can look similarly, but behave differently! Do not confuse!
...
\begin{frame}[fragile]{Looking for files and applications}
  \begin{bashcode}
    ...
    exit 1 # Use to be added (with various numbers) after any error to
           ...
           # Exit status 1 is general error.
  \end{bashcode}
\end{frame}
