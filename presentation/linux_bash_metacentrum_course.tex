...
\begin{frame}{Ubuntu with Unity} % TODO Update print screen, add more
  \begin{center}
...
\begin{frame}{Debian with XFCE --- Xubuntu has more ``modern'' design} % TODO Update print screen, add more
  \begin{center}
...
% * Filemanagers (e.g. default vs. tunned Dolphin)
% * Editing DE settings
% * Managing global settings and applications
% * What is stored where
% * Compare XFCE in Debian, XFCE, openSUSE, Fedora?
...
\begin{frame}{Everything is (text) file}
  \begin{itemize}
    ...
    \end{itemize}
    \item When transfering to and from Windows, be awareof EOL and encoding!
    \item FAT32 (commonly used for USB flash disks) has limits to maximal file size and range of characters allowed in file name is limited
    \begin{itemize}
