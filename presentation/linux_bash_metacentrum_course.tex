...
\begin{frame}[fragile]{Graphical interactive task}
	...
	\end{bashcode}
	\begin{itemize}
		\item Launch your favorite VNC client (\href{https://apps.kde.org/krdc}{KRDC}, \href{https://www.tightvnc.com/}{TightVNC}, \href{https://tigervnc.org/}{TigerVNC}~\ldots) and use credentials from above output to connect
