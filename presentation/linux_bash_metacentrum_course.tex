...
\begin{frame}[allowframebreaks]{Distributed topology}
	...
	\begin{itemize}
		...
		\item There are 9~\href{https://docs.metacentrum.cz/en/docs/computing/infrastructure/frontends}{frontends} where user logs via SSH and prepare computing task for submission etc. (see further)
