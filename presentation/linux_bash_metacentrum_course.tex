...
\begin{frame}[fragile]{Get a column with awk}
  \begin{itemize}
    ...
    \item AWK can not select column according to its name (Perl can do that)
    \item AWK can do things other BASH tools can not do (easily) -- better manipulation with columns, calculations,~\ldots
    \item AWK has complicated syntax, it is hard to read, it is not similar to other tools -- Perl can do more and is more common\ldots
...
% \begin{frame}{Launching of Windows and DOS applications in Linux} % TODO Wine
%   \begin{itemize}
%     \item 
%   \end{itemize}
% \end{frame}
...
% \subsection{Resources} % TODO Resources
