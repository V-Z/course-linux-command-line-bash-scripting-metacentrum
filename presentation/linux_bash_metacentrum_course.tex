...
\begin{frame}{Virtual machine for learning}
	...
	\begin{multicols}{2}
		\begin{itemize}
			...
			\item Download openSUSE Leap 15.2 Linux distribution for this course from \url{https://botany.natur.cuni.cz/zeisek/openSUSE_Leap_courses.ova} ($\sim$4.9~GB)
...
\begin{frame}{Graphical User Interfaces (GUI)}{More like \enquote{Mac-style}, \enquote{Windows-style} or something else? Feature rich or minimalistic?}
	\begin{itemize}
		...
		\item \href{https://kde.org/}{KDE} --- one of the most common, feature extremely rich, basically \enquote{Windows-like} (can be changed)
...
\begin{frame}{Expressions and variables notes}
	\begin{itemize}
...
\begin{frame}[fragile]{Working with PATH variable}
	\begin{bashcode}
...
\begin{frame}{Variables and quotes and more I}
	\label{varquotes}
	\begin{itemize}
...
\begin{frame}[fragile]{Variables and quotes and more II}{How quotes influence reading of variable content}
	\begin{bashcode}
...
\begin{frame}[fragile]{Redirects of standard input and output III}{Try everything and be sure to understand}
	\begin{bashcode}
...
\begin{frame}[fragile]{Which system are we using? I}
	\begin{bashcode}
...
\begin{frame}[fragile]{Which system are we using? II}
	\begin{bashcode}
...
\begin{frame}[fragile]{Basic network information and testing II}
	\begin{bashcode}
...
\begin{frame}{Importance of good text editor}{Can your text editor\ldots ?}
	...
	\begin{multicols}{4}
		\begin{itemize}
			...
			\item \href{https://apps.kde.org/en/kwrite}{KWrite}
...
\begin{frame}[allowframebreaks]{CESNET and MetaCentrum}
	...
	\begin{itemize}
		...
		\item Most of practical information for users are at wiki \url{https://wiki.metacentrum.cz/wiki/Main_Page}
	\end{itemize}
\end{frame}
...
\begin{frame}{MetaCentrum}
	\begin{itemize}
		...
		\item It has 11~\href{https://wiki.metacentrum.cz/wiki/Frontend}{front ends} where users log and thousands of computers doing the calculations --- they are not accessed directly to run task
...
\begin{frame}[fragile]{MetaCentrum usage}
	\begin{itemize}
		\item User can transfer data on one of \href{https://wiki.metacentrum.cz/wiki/Frontend}{front ends} (next slide) by e.g. \texttt{scp} or \href{https://winscp.net/}{WinSCP} from Windows or \href{https://filezilla-project.org/}{FileZilla} from anywhere
...
\begin{frame}{File transfers to MetaCentrum}
	\begin{itemize}
		\item Graphical applications: e.g. \href{https://filezilla-project.org/}{FileZilla} or from most of file managers
		\item Protocol is SSH/SSH2/SFTP/SCP, port 22, server is selected \href{https://wiki.metacentrum.cz/wiki/Frontend}{front end's} address (e.g. \texttt{tarkil.metacentrum.cz}) --- select any and keep using it
	...
	\end{itemize}
	\includegraphics[width=\textwidth-1cm]{gftp.png}
\end{frame}
...
\begin{frame}{MetaCentrum task}
	\begin{enumerate}
		...
		\item Submit the task via \texttt{qsub} and .
...
\begin{frame}{Running VNC}
	\begin{center}
		\includegraphics[width=\textwidth-3cm]{vnc.png}
	\end{center}
\end{frame}
