\documentclass[compress, ucs, xelatex, 11pt, xcolor=svgnames, aspectratio=1610,
	hyperref={
		bookmarks=true,
		unicode=true,
		colorlinks=true,
...
\begin{frame}{Midnight Commander}
	\begin{multicols}{2}
		...
		\end{itemize}
		\includegraphics[height=7cm]{mc.png}
	\end{multicols}
\end{frame}
...
\begin{frame}{Searching tasks}
	...
	\begin{block}{Tasks with \texttt{find}}
		\begin{enumerate}
			...
			\item List all directories in \texttt{/etc} up to sesond level.
		\end{enumerate}
	\end{block}
\end{frame}
...
\begin{frame}{Comparisons}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[height=5cm]{kompare.png}
	\end{center}
\end{frame}
...
\begin{frame}{Graphical package managers I}{Ubuntu Software, and Synaptic and text-based Aptitude for all DEB-based distributions}
	\begin{center}
		\includegraphics[width=\textwidth-2cm]{software_managers_ubuntu_deb.png}
	\end{center}
\end{frame}
...
\begin{frame}{winefile, winetricks and winecfg}
	\begin{center}
		\includegraphics[width=\textwidth-1.5cm]{wine.png}
	\end{center}
\end{frame}
...
% * Možná dát k sobě všechny věci týkající se globbingu, výrazů, proměnných apod. v BASHi
